    ...
    <section className="items-center gap-5 py-20 my-10 space-y-10 md:flex px-xPadding bg-green500 md:space-y-0">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-6">
          <a
            href="/creator"
            className="px-4 py-3 bg-transparent border-2 border-solid rounded-md border-orange800 text-orange800"
          >
            Learn More
          </a>
          ...
          <a
            ...
            className="px-8 py-3 text-white rounded-md bg-orange800"
          >
            Join Us
          </a>
        </div>
