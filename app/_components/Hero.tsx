...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className='flex gap-2 items-center bg-white rounded-md w-[40%] md:w-full p-4'>
        <RiSearch2Line size={24} className="md:text-[1em]"/>
        <input type='text' className='outline-none focus:outline-none md:w-full' placeholder='Search for Images here...'/>
      </div>
    </section>
  );
}
